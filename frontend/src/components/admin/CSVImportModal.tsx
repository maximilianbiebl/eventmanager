...
const FORMATS: {
  ...
  tasks: {
    ...
    columns: [
      ...
      { name: 'row_type', required: false, hint: 'aufgabe (Vorgabe) oder gruppe – eine Gruppenzeile beschreibt nur die Überschrift' },
      ...
      { name: 'group_color', required: false, hint: 'Farbe der Gruppe: blau, gruen, gelb, rot, violett, tuerkis, braun, grau' },
      { name: 'group_series_name', required: false, hint: 'Serie der Gruppe (nur in Gruppenzeilen)' },
    ...
    note: 'Felder mit Komma bitte in Anführungszeichen setzen: "Aufbau, Halle 2". Serien werden bei Bedarf angelegt; wer darin mitarbeitet, wird danach in der Serienverwaltung eingetragen. Der Personalbedarf ist unverbindlich - die Spalten dürfen auch ganz fehlen. Eine Zeile mit row_type=gruppe legt eine Aufgabengruppe an, auch ohne eigene Aufgaben - so überlebt eine reine Zwischenüberschrift den Weg durch die Datei. Fehlt row_type ganz, gilt jede Zeile als Aufgabe.',
  },
};
