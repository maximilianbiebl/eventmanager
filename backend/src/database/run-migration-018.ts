...
async function runMigration() {
  ...
  try {
    console.log('Starting migration 018: Personalbedarf je Aufgabe...');
    ...
    console.log('✓ Migration 018 abgeschlossen: Aufgaben koennen jetzt einen Personalbedarf tragen.');
  } catch (error: any) {
    await client.query('ROLLBACK');
    // Fehlermeldung des Servers durchreichen - sie sagt, was schiefging.

    console.error('\nMigration 018 nicht ausgefuehrt:');
